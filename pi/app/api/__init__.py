...
from . import routes_state, routes_anchors, routes_fixtures, routes_calibration, routes_health, routes_tracking, routes_settings, routes_devices, routes_events, routes_dmx  # noqa: F401
